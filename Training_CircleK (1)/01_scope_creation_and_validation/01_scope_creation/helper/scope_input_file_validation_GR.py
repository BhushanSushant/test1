...
FILE_DIR = "/dbfs/Phase3_extensions/Elasticity_Modelling/Apr22_Test_Refresh/GR_Repo/Input/gr_final_scope_Apr22_Test_refresh.xlsx"  # for TX BU pre-BU inputs
...
#df.loc[df['total_sales_amount'].isin(['']), 'total_sales_amount'] = '0'           #comment out total_sales_amount
